# =========================================================
# ClickByChris Setup Tool V5.0 Ultra Premium - Multi-PC Stage 2
# Multi-PC Stage 1 - Portable paths + launcher + startup checks
...
function Show-ExecutionSummaryDialog {
    ...
    try {
        ...
        $summaryForm.Size = New-Object System.Drawing.Size(920,620)
        $summaryForm.MinimumSize = New-Object System.Drawing.Size(820,520)
        ...
        $header.Dock = "Top"
        $header.Height = 108
        $header.BackColor = [System.Drawing.Color]::FromArgb(24,24,32)
        $summaryForm.Controls.Add($header)

        $titleLbl = New-Object System.Windows.Forms.Label
        $titleLbl.Text = "Résumé de l'action terminée"
        $titleLbl.Location = [System.Drawing.Point]::new(24,16)
        $titleLbl.Size = New-Object System.Drawing.Size(600,34)
        $titleLbl.Font = New-Object System.Drawing.Font("Segoe UI Semibold",18,[System.Drawing.FontStyle]::Bold)
        $titleLbl.ForeColor = [System.Drawing.Color]::WhiteSmoke
        $header.Controls.Add($titleLbl)

        $subLbl = New-Object System.Windows.Forms.Label
        $subLbl.Text = "$Title - $ok OK / $warn avertissement(s) / $err erreur(s) / $skip ignore(s)"
        $subLbl.Location = [System.Drawing.Point]::new(26,56)
        $subLbl.Size = New-Object System.Drawing.Size(780,28)
        $subLbl.Font = New-Object System.Drawing.Font("Segoe UI",11,[System.Drawing.FontStyle]::Regular)
        $subLbl.ForeColor = [System.Drawing.Color]::Gainsboro
        $header.Controls.Add($subLbl)

        $grid = New-Object System.Windows.Forms.DataGridView
        $grid.Location = [System.Drawing.Point]::new(22,128)
        $grid.Size = New-Object System.Drawing.Size(860,360)
        ...
        [void]$grid.Columns.Add("Status","État")
        [void]$grid.Columns.Add("Name","Action")
        [void]$grid.Columns.Add("Detail","Détail")
        ...
        $csvLbl.Text = if ([string]::IsNullOrWhiteSpace($CsvPath)) { "Rapport CSV : non exporté" } else { "Rapport CSV : $CsvPath" }
        $csvLbl.Location = [System.Drawing.Point]::new(24,502)
        $csvLbl.Size = New-Object System.Drawing.Size(690,28)
        $csvLbl.Anchor = "Left,Right,Bottom"
        $csvLbl.Font = New-Object System.Drawing.Font("Segoe UI",9,[System.Drawing.FontStyle]::Regular)
        ...
        $btnOpenLogs.Size = New-Object System.Drawing.Size(110,38)
        $btnOpenLogs.Location = [System.Drawing.Point]::new(642,538)
        ...
        $btnOk.Text = "OK"
        $btnOk.Size = New-Object System.Drawing.Size(110,38)
        $btnOk.Location = [System.Drawing.Point]::new(770,538)
        ...
        Write-Log "Impossible d afficher le résumé visuel : $($_.Exception.Message)" "WARN"
    }
}
...
function Show-ExecutionSummary {
    ...
    if (-not $Script:ActionResults -or $Script:ActionResults.Count -eq 0) {
        Write-Log "Aucun resultat detaille a afficher pour : $Title" "WARN"
        return
    }
    ...
    foreach ($r in $Script:ActionResults) {
        switch ($r.Status) {
            "OK"    { Write-Log "[OK] $($r.Name) : $($r.Detail)" "INFO" }
    ...
    try {
        ...
        Write-Log "Rapport exporte : $csvPath"
    } catch {
        Write-Log "Impossible d exporter le rapport : $($_.Exception.Message)" "WARN"
    }
...
function Invoke-WingetLogged {
    ...
    try {
        Write-Log "$Label : winget $($Arguments -join ' ')"
        & winget @Arguments 2>&1 | ForEach-Object {
            $line = [string]$_
            if (-not [string]::IsNullOrWhiteSpace($line)) {
                $clean = ($line -replace '\s+',' ').Trim()
                if ($clean.Length -gt 0 -and $clean -notmatch '^[\\-\\\\\\|\\/\\s]+$') {
                    $outputLines.Add($clean) | Out-Null
                    Write-Log "$Label : $clean"
                }
            }
            [System.Windows.Forms.Application]::DoEvents()
        }
...
function Install-OrUpgrade {
    ...
    try {
        Write-Log "--------------------------------------------"
        Write-Log "Controle de $DisplayName"
        Write-Log "Identifiant winget : $WingetId"

        $listOutput = Invoke-WingetLogged -Arguments @("list","--id",$WingetId,"--exact") -Label "$DisplayName / verification"
        $isInstalled = -not ($listOutput -match "No installed package found matching input criteria" -or $listOutput -match "Aucun package installe" -or $listOutput -match "No installed package")

        if (-not $isInstalled) {
            Write-Log "$DisplayName absent : installation en cours..."
            [void](Invoke-WingetLogged -Arguments @("install","--id",$WingetId,"-e","--accept-package-agreements","--accept-source-agreements","--silent") -Label "$DisplayName / installation")
        }
        else {
            Write-Log "$DisplayName deja detecte : verification de mise a jour..."
            [void](Invoke-WingetLogged -Arguments @("upgrade","--id",$WingetId,"-e","--accept-package-agreements","--accept-source-agreements","--silent") -Label "$DisplayName / mise a jour")
        }

        Start-Sleep -Milliseconds 900
        Write-Log "$DisplayName : verification finale..."
        if (Test-WingetPackageInstalled -WingetId $WingetId) {
            Add-ExecutionResult -Name $DisplayName -Status "OK" -Detail "Installe, mis a jour ou deja present"
            return $true
        }
        else {
            Add-ExecutionResult -Name $DisplayName -Status "WARN" -Detail "Commande lancee, mais winget list ne confirme pas l installation"
            return $false
        }
    }
    catch {
...
$homeTitle.Text = "Bienvenue dans ClickByChris Setup Tool"
...
$null = Add-OptCheckbox -Parent $panelSafe -Key 'SafeOneDrive'  -Text "Desactiver OneDrive si la personne ne l utilise pas" -X 20 -Y 284 -Checked $false
$null = Add-OptCheckbox -Parent $panelSafe -Key 'SafeIndexing'  -Text "Limiter l indexation Windows (recherche moins agressive)" -X 20 -Y 316 -Checked $false
...
$null = Add-OptCheckbox -Parent $panelGaming -Key 'GameMode'    -Text "Activer le Game Mode Windows" -X 20 -Y 124 -Checked $true
...
$null = Add-OptCheckbox -Parent $panelGaming -Key 'GameDVR'     -Text "Desactiver Xbox Game DVR et les captures en arriere-plan" -X 20 -Y 188 -Checked $true
...
$logsTitle.Text = "Logs en temps reel"
$logsTitle.Location = [System.Drawing.Point]::new(20,12)
$logsTitle.Size = New-Object System.Drawing.Size(300,24)
$logsTitle.Font = New-Object System.Drawing.Font("Segoe UI",12,[System.Drawing.FontStyle]::Bold)
$logsTitle.ForeColor = $white
$pageLogs.Controls.Add($logsTitle)

$Script:LogBox = New-Object System.Windows.Forms.RichTextBox
$Script:LogBox.Location = [System.Drawing.Point]::new(20,45)
$Script:LogBox.Size = New-Object System.Drawing.Size(1020,540)
$Script:LogBox.Anchor = 'Top,Bottom,Left,Right'
$Script:LogBox.BackColor = $bgCard
$Script:LogBox.ForeColor = $white
