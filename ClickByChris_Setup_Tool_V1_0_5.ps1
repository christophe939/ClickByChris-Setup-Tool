# =========================================================
# ClickByChris Setup Tool V1.0.5 Ultra Premium - Multi-PC Stage 2
...
Write-Host "🖥️  DÉTECTION MULTI-ÉCRAN - ClickByChris Setup Tool V1.0.5" -ForegroundColor Cyan
Write-Host "═══════════════════════════════════════════════════════════" -ForegroundColor Cyan
...
if ($Script:AllScreens.Count -gt 1) {
    Write-Host "`n📺 Écrans connectés :" -ForegroundColor Cyan
    foreach ($screen in $Script:AllScreens) {
        $marker = if ($screen.IsPrimary) { "🔵 PRINCIPAL" } else { "⚪ SECONDAIRE" }
        Write-Host "  $marker - $($screen.Name): $($screen.Width)x$($screen.Height) ($($screen.Ratio):1)" -ForegroundColor Gray
    }
}
...
Write-Host ""
Write-Host "╔════════════════════════════════════════════════════════════╗" -ForegroundColor Cyan
Write-Host "║  ClickByChris Setup Tool V1.0.4 - Interface en cours...   ║" -ForegroundColor Cyan
